                     ...
                     <div class="card ">
                        ...
                        <div class="card-block">
                           <div class="row">
                              ...
                              <div class="col-md-12">
                                <form action="" method="post" role="form" class="simpan-kuis">
                                  <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Nama Kuis</label>
                                    <div class="col-sm-10">
                                      <input type="text" name="nama_kuis" class="form-control">
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Tanggal Kuis</label>
                                    <div class="col-sm-10">
                                      <input type="date" date-format="dd-mm-yyyy" name="tanggal_kuis" class="form-control">
                                    </div>
                                  </div>
                                  <div class="form-group row">
