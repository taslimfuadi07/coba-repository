                        ...
                        <div class="card-block">
                           <div class="row">
                            <div class="col-md-4 m-b-20">
                              <a href="./input_pertanyaan" class="btn btn-primary btn-sm">Tambah Pertanyaan</a>
                            </div>
                              <div class="col-md-12">
                                 <table class="  table table-striped table-bordered" id="data_table_majalah"  cellpadding="0" cellspacing="0" border="0" class="" width="100%">
                                    <thead>
                                       <tr>
                                          <th>No</th>
                                          <th>Pertanyaan</th>
