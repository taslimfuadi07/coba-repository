...
<!-- Mirrored from colorlib.com//polygon/admindek/default/index.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 08 Mar 2019 08:48:57 GMT -->
			...
			<div class="navbar-wrapper">
				...
				<div class="navbar-container container-fluid">
					<ul class="nav-left">
						...
						<li>
							<a href="#!" onclick="if (!window.__cfRLUnblockHandlers) return false; javascript:toggleFullScreen()" class="waves-effect waves-light" data-cf-modified-cb5fc8e3412bf910369fedd2-="">
													...
													<table class="table table-hover m-b-0">
														...
														<tbody>
															<tr>
																<td>Sofa</td>
																<td>#PHD001</td>
																<td><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1e7f7c7d5e79737f7772307d7173">[email&#160;protected]</a></td>
															...
															<tr>
																<td>Computer</td>
																<td>#PHD002</td>
																<td><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4122252201262c20282d6f222e2c">[email&#160;protected]</a></td>
															...
															<tr>
																<td>Mobile</td>
																<td>#PHD003</td>
																<td><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7a0a0b083a1d171b131654191517">[email&#160;protected]</a></td>
																<td><label class="label label-danger">Out Stock</label></td>
																<td>
																	<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
																	<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
															...
															<tr>
																<td>Coat</td>
																<td>#PHD004</td>
																<td><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="482a2b3b082f25292124662b2725">[email&#160;protected]</a></td>
																<td><label class="label label-success">In Stock</label></td>
																<td>
																	<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
																	<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
															...
															<tr>
																<td>Watch</td>
																<td>#PHD005</td>
																<td><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1370777053747e727a7f3d707c7e">[email&#160;protected]</a></td>
																<td><label class="label label-success">In Stock</label></td>
																<td>
																	<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
																	<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
															...
															<tr>
																<td>Shoes</td>
																<td>#PHD006</td>
																<td><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e5959497a58288848c89cb868a88">[email&#160;protected]</a></td>
																<td><label class="label label-danger">Out Stock</label></td>
																<td>
																	<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
																	<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
...
<script type="cb5fc8e3412bf910369fedd2-text/javascript" src="<?php echo base_url() ?>assets/js/jquery-2.1.4.min.js"></script>
<script type="cb5fc8e3412bf910369fedd2-text/javascript" src="<?php echo base_url() ?>assets/js/jquery-ui.min.js"></script>
<script type="cb5fc8e3412bf910369fedd2-text/javascript" src="<?php echo base_url() ?>assets/js/popper.min.js"></script>
<script type="cb5fc8e3412bf910369fedd2-text/javascript" src="<?php echo base_url() ?>assets/js/bootstrap.min.js"></script>

<script src="<?php echo base_url() ?>assets/plugin/waves/js/waves.min.js" type="cb5fc8e3412bf910369fedd2-text/javascript"></script>

<script type="cb5fc8e3412bf910369fedd2-text/javascript" src="<?php echo base_url() ?>assets/plugin/jquery-slimscroll/js/jquery.slimscroll.js"></script>

<script src="<?php echo base_url() ?>assets/plugin/chart/float/jquery.flot.js" type="cb5fc8e3412bf910369fedd2-text/javascript"></script>
<script src="<?php echo base_url() ?>assets/plugin/chart/float/jquery.flot.categories.js" type="cb5fc8e3412bf910369fedd2-text/javascript"></script>
<script src="<?php echo base_url() ?>assets/plugin/chart/float/curvedLines.js" type="cb5fc8e3412bf910369fedd2-text/javascript"></script>
<script src="<?php echo base_url() ?>assets/plugin/chart/float/jquery.flot.tooltip.min.js" type="cb5fc8e3412bf910369fedd2-text/javascript"></script>

<script src="<?php echo base_url() ?>assets/plugin/chartist/js/chartist.js" type="cb5fc8e3412bf910369fedd2-text/javascript"></script>

<script src="<?php echo base_url() ?>assets/plugin/widget/amchart/amcharts.js" type="cb5fc8e3412bf910369fedd2-text/javascript"></script>
<script src="<?php echo base_url() ?>assets/plugin/widget/amchart/serial.js" type="cb5fc8e3412bf910369fedd2-text/javascript"></script>
<script src="<?php echo base_url() ?>assets/plugin/widget/amchart/light.js" type="cb5fc8e3412bf910369fedd2-text/javascript"></script>

<script src="<?php echo base_url() ?>assets/js/pcoded.min.js" type="cb5fc8e3412bf910369fedd2-text/javascript"></script>
<script src="<?php echo base_url() ?>assets/js/vertical/vertical-layout.min.js" type="cb5fc8e3412bf910369fedd2-text/javascript"></script>
<script type="cb5fc8e3412bf910369fedd2-text/javascript" src="<?php echo base_url() ?>assets/plugin/dashboard/custom-dashboard.min.js"></script>
<script type="cb5fc8e3412bf910369fedd2-text/javascript" src="<?php echo base_url() ?>assets/js/script-admin.min.js"></script>

 
<script src="<?php echo base_url() ?>assets/js/rocket-loader.min.js" data-cf-settings="cb5fc8e3412bf910369fedd2-|49" defer=""></script></body>
